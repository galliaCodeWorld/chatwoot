<template>
  <ValidationObserver ref="contact_prov" v-slot="{ handleSubmit }">
    <form ref="opportunity_contact_form"
        ...
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='title' v-model="opportunityState.opportunity.title" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <b-icon class="field--icon" icon="x-circle" scale="1" variant="danger" v-show="failed" />
              <b-icon class="field--icon" icon="check-square" scale="1" variant="success" v-show="passed" />
              <md-input name='company' v-model="opportunityState.opportunity.company" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
        ...
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <b-icon class="field--icon" icon="x-circle" scale="1" variant="danger" v-show="failed" />
              <b-icon class="field--icon" icon="check-square" scale="1" variant="success" v-show="passed" />
              <md-input name='alt_email' v-model="opportunityState.opportunity.alt_email" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <b-icon class="field--icon" icon="x-circle" scale="1" variant="danger" v-show="failed" />
              <b-icon class="field--icon" icon="check-square" scale="1" variant="success" v-show="passed" />
              <md-input name='mobile' v-model="opportunityState.opportunity.mobile" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
            ...
            >
              <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
                ...
                <md-input name='street_1' placeholder="Street 1.."
                  v-model="opportunityState.opportunity.street_1" type="text" />
              </md-field>
            </ValidationProvider>
          </div>
          <div class="md-layout">
            ...
            >
              <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
                ...
                <md-input name='street_2' placeholder="Street 2.."
                  v-model="opportunityState.opportunity.street_2" type="text" />
              </md-field>
            </ValidationProvider>
          </div>
          <div class="md-layout">
              ...
              >
                <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
                  ...
                  <md-input name='city' placeholder="City.."
                    v-model="opportunityState.opportunity.city" type="text" />
                </md-field>
              </ValidationProvider>
            </div>
            <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
              ...
              >
                <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
                  ...
                  <md-input name='state' placeholder="State.."
                    v-model="opportunityState.opportunity.state" type="text" />
                </md-field>
              </ValidationProvider>
            </div>
          </div>
              ...
              >
                <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
                  ...
                  <md-input name='zip' placeholder="Zip Code.."
                    v-model="opportunityState.opportunity.zip" type="text" />
                </md-field>
              </ValidationProvider>
            </div>
            <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
              <md-field class="field">
                <multiselect :max-height="150" style="color: black;" v-model="opportunityState.opportunity.country"
                  placeholder="Country.."
            ...
            >
              <md-field class="field" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
                ...
                <md-input name='referred_by' placeholder="Referred by"
                  v-model="opportunityState.opportunity.referred_by" type="text" />
              </md-field>
            </ValidationProvider>
          </div>
          <div class="md-layout">
            <b-form-checkbox v-model="opportunityState.opportunity.do_not_call">
...
<script>
  ...
  extend('max', max);
  export default {
    name: 'opportunities-lists-contact',
    props: {
      sending: {
        type: Boolean,
        default: false
