      ...
      <div class="md-layout">
        ...
        >
          <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
            ...
            <md-input name='blog' v-model="opportunityState.opportunity.blog" type="text" />
          </md-field>
        </ValidationProvider>
      </div>
      <div class="md-layout">
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='twitter' v-model="opportunityState.opportunity.twitter" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='linkedin' v-model="opportunityState.opportunity.linkedin" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
        ...
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='facebook' v-model="opportunityState.opportunity.facebook" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='skype' v-model="opportunityState.opportunity.skype" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
