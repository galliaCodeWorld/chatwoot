      ...
      <div class="md-layout">
        ...
        >
          <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
            ...
            <md-input name='blog' v-model="campaineState.campaine.blog" type="text" />
          </md-field>
        </ValidationProvider>
      </div>
      <div class="md-layout">
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='twitter' v-model="campaineState.campaine.twitter" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='linkedin' v-model="campaineState.campaine.linkedin" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
        ...
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='facebook' v-model="campaineState.campaine.facebook" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='skype' v-model="campaineState.campaine.skype" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
