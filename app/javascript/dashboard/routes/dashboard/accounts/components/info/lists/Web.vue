      ...
      <div class="md-layout">
        ...
        >
          <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
            ...
            <md-input name='blog' v-model="accountState.account.blog" type="text" />
          </md-field>
        </ValidationProvider>
      </div>
      <div class="md-layout">
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='twitter' v-model="accountState.account.twitter" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='linkedin' v-model="accountState.account.linkedin" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
        ...
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='facebook' v-model="accountState.account.facebook" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
          ...
          >
            <md-field style="margin: 0;" :class="[{ 'md-error': failed }, { 'md-valid': passed }]">
              ...
              <md-input name='skype' v-model="accountState.account.skype" type="text" />
            </md-field>
          </ValidationProvider>
        </div>
      </div>
